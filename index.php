...
$mainContent = [
  ...
  [
    ...
    "paragraphs" => [
      ...
      "<ol><li><p>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:</p>
        <ol><li><p>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</p></li>
        <li><p>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</p></li></ol></li>
        <li><p>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</p></li></ol>",
    ...
    <div class="container">
      ...
      foreach ($mainContent as $section) {
        ...
        if (isset($section["subTitle"]))
          echo "<h5>" . $section["subTitle"] . "</h5>";

        if (isset($section["subParagraphs"])) {
          foreach ($section["subParagraphs"] as $subParagraph) {
            echo $subParagraph;
          }
        }
        echo "</section>";
